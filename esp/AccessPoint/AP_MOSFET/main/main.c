...
#define ADC_v1 ADC1_CHANNEL_2 // GPIO 2
#define ADC_c1 ADC1_CHANNEL_3 // GPIO 3

// gpio 4 RESET
#define brown_detect_gpio 21
#define test_gpio 6
...
static const char *TAG = "GV mosfet";
...
static void ws_async_send(void *arg)
{
	...
	uint32_t voltage2 = 0.; //adc1_get_raw(ADC_v2);

	uint32_t current1 = adc1_get_raw(ADC_c1);
	uint32_t current2 = 0.; //adc1_get_raw(ADC_c2);
